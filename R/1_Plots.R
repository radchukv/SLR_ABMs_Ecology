...
ggplot() +
  ...
  geom_rect(aes(xmin = 1.5, xmax = 2.5,
                ymin = -edge_rec, ymax = sum(answers_together$Q0 == "Yes")+  edge_rec), 
...
ggplot() +
  ...
  geom_rect(aes(xmin = 1.5, xmax = 3.5,
                ymin = -edge_rec, ymax = max(sum(answers_together$Q0 == "Yes"), sum(answers_together$Q1 == "Not as questions, but explicit aim or obejective"))+edge_rec), 
            col = color_chosen, alpha = 0) +
...
y_max = max(c(sum(answers_together$Q3 == "Q3.1"), sum(answers_together$Q3 == "Q3.2"),
              sum(answers_together$Q3 == "Q3.3"), sum(answers_together$Q3 == "Q3.4")))
...
ggplot() +
  ...
  geom_rect(aes(xmin = 1.5, xmax = 3.5,
                ymin = -edge_rec, ymax = max(sum(answers_together$Q4 == "Yes"),sum(answers_together$Q4 == "No keyword search applied")) + edge_rec), 
            col = color_chosen, alpha = 0) +
  theme_bw() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) 
...
ggplot() +
  ...
  geom_rect(aes(xmin = 1.5, xmax = 2.5,
                ymin = -edge_rec, ymax =  sum(answers_together$Q14 == "Yes") + edge_rec), 
            col = color_chosen, alpha = 0) +
  theme_bw() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) 
...
ggplot() +
  ...
  geom_rect(aes(xmin = 1.5, xmax = 2.5,
                ymin = -0.5, ymax = sum(answers_together$Q21 == "Yes") + 0.5), 
            col = color_chosen, alpha = 0) +
  theme_bw() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) 
...
ggplot() +
  ...
  geom_rect(aes(xmin = 1.5, xmax = 2.5,
                ymin = -edge_rec, ymax = sum(answers_together$Q30 == "Yes") + edge_rec), 
            col = color_chosen, alpha = 0) +
  theme_bw() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) 
...
ggplot(data = data.frame(Q36_sum),aes(seq_along(Q36_sum),Q36_sum)) +
  geom_bar(stat = "identity") +
  scale_x_continuous(name = "Q11", breaks = c(1,2,3,4,5,6), labels = names_Q36) +
  ylab("count") +
  theme_bw() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank())
...
ggplot(data = answers_together, aes(axis1 = practise_Q1, axis2 = practise_Q3, 
  ...
  scale_x_discrete(limits = c("Q1", "Q3", "Q4", "Q11", "Q14", "Q21", "Q27", "Q30", "Q36"), expand = c(.05, .05)) +
...
## Jo: actual names are quite long should I apply them anyways?
